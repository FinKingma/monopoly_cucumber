<template>
  <div class="table" id="table">
    <div class="board">
      ...
      <div class="space corner go" id="pos1">
        <div class="container">
      ...
      <div class="row horizontal-row bottom-row">
        <div class="space property" id="pos32">
          <div class="container">
        ...
        <div class="space property" id="pos33">
          <div class="container">
            <div class="color-bar light-blue"></div>
        ...
        <div class="space chance" id="pos34">
          <div class="container">
            <div class="name">Chance</div>
            <i class="drawing fa fa-question"></i>
          </div>
        </div>
        <div class="space property" id="pos35">
          <div class="container">
            <div class="color-bar light-blue"></div>
        ...
        <div class="space railroad" id="pos36">
          <div class="container">
        ...
        <div class="space fee income-tax" id="pos37">
          <div class="container">
        ...
        <div class="space property" id="pos38">
          <div class="container">
        ...
        <div class="space community-chest" id="pos39">
          <div class="container">
        ...
        <div class="space property" id="pos40">
          <div class="container">
            <div class="color-bar dark-purple"></div>
      ...
      <div class="space corner jail" id="pos31">
      ...
      <div class="row vertical-row left-row">
        <div class="space property" id="pos22">
          <div class="container">
        ...
        <div class="space property" id="pos23">
          <div class="container">
            <div class="color-bar orange"></div>
        ...
        <div class="space community-chest" id="pos24">
          <div class="container">
            <div class="name">Community Chest</div>
            <i class="drawing fa fa-cube"></i>
            <div class="instructions">Follow instructions on top card</div>
        ...
        <div class="space property" id="pos25">
          <div class="container">
            <div class="color-bar orange"></div>
        ...
        <div class="space railroad" id="pos26">
          <div class="container">
        ...
        <div class="space property" id="pos27">
          <div class="container">
        ...
        <div class="space property" id="pos28">
          <div class="container">
            <div class="color-bar purple"></div>
        ...
        <div class="space utility electric-company" id="pos29">
          <div class="container">
        ...
        <div class="space property" id="pos30">
          <div class="container">
            <div class="color-bar purple"></div>
      ...
      <div class="space corner free-parking" id="pos21">
        <div class="container">
      ...
      <div class="row horizontal-row top-row">
        <div class="space property" id="pos20">
          <div class="container">
        ...
        <div class="space chance" id="pos19">
          <div class="container">
            <div class="name">Chance</div>
            <i class="drawing fa fa-question blue"></i>
          </div>
        </div>
        <div class="space property" id="pos18">
          <div class="container">
            <div class="color-bar red"></div>
        ...
        <div class="space property" id="pos17">
          <div class="container">
            <div class="color-bar red"></div>
        ...
        <div class="space railroad" id="pos16">
          <div class="container">
        ...
        <div class="space property" id="pos15">
          <div class="container">
        ...
        <div class="space property" id="pos14">
          <div class="container">
            <div class="color-bar yellow"></div>
        ...
        <div class="space utility waterworks" id="pos13">
          <div class="container">
        ...
        <div class="space property" id="pos12">
          <div class="container">
            <div class="color-bar yellow"></div>
      ...
      <div class="space corner go-to-jail" id="pos11">
        <div class="container">
      ...
      <div class="row vertical-row right-row" id="pos10">
        ...
        <div class="space property" id="pos9">
          <div class="container">
            <div class="color-bar green"></div>
        ...
        <div class="space community-chest" id="pos8">
          <div class="container">
            <div class="name">Community Chest</div>
            <i class="drawing fa fa-cube"></i>
            <div class="instructions">Follow instructions on top card</div>
        ...
        <div class="space property" id="pos7">
          <div class="container">
            <div class="color-bar green"></div>
        ...
        <div class="space railroad" id="pos6">
          <div class="container">
        ...
        <div class="space chance" id="pos5">
          <div class="container">
            <div class="name">Chance</div>
            <i class="drawing fa fa-question"></i>
          </div>
        </div>
        <div class="space property" id="pos4">
          <div class="container">
        ...
        <div class="space fee luxury-tax" id="pos3">
          <div class="container">
        ...
        <div class="space property" id="pos2">
          <div class="container">
            <div class="color-bar dark-blue"></div>
